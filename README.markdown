...
This directory contains source files for the Hindi language morphology
...
-   <https://giellalt.uit.no/lang/hin/index.html> (analyser)
-   <https://giellalt.uit.no/index.html> (infrastructure)

Requirements
------------

In order to compile and use Hindi language morphology and dictionaries,
you need:
...
The Hindi language sources can be acquired using [giella SVN
