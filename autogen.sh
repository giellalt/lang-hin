...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_hin to login script."
...
# the current dir:
if   test x${GTLANG_hin} = x ; then
	echo "WARNING: The variable \${GTLANG_hin} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_hin} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_hin} has the value:"
	echo "  ${GTLANG_hin}"
